...
enum ReloadType {
	RELOADTYPE_GLOBAL = 1,
	RELOADTYPE_ACTIONS = 2,
	RELOADTYPE_CONFIG = 3,
	RELOADTYPE_COMMANDS = 4,
	RELOADTYPE_CREATURESCRIPTS = 5,
	RELOADTYPE_MONSTERS = 6,
	RELOADTYPE_MOVEMENTS = 7,
	RELOADTYPE_NPCS = 8,
	RELOADTYPE_RAIDS = 9,
	RELOADTYPE_SPELLS = 10,
	RELOADTYPE_TALKACTIONS = 11,
	RELOADTYPE_ITEMS = 12,
	RELOADTYPE_WEPONS = 13,
	RELOADTYPE_QUESTS = 14,
	RELOADTYPE_MOUNTS = 15,
	RELOADTYPE_GLOBALEVENTS = 16,
	RELOADTYPE_EVENTS = 17,
	RELOADTYPE_CHATCHANNELS = 18,
	RELOADTYPE_LAST = 19
};
