	...
	for (Tile* tile : tileList) {
		...
		if (CreatureVector* creatures = tile->getCreatures()) {
			...
			for (Creature* creature : *creatures) {
				...
				if (!params.isAggressive || (caster != creature && Combat::canDoCombat(caster, creature, params.isAggressive) == RET_NOERROR)) {
...
{
	bool canCombat = !params.isAggressive || (caster != target && Combat::canDoCombat(caster, target, !params.isAggressive) == RET_NOERROR);
